...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['_accion'])) {
    ...
    if ($accion === 'crear_evento') {
        ...
        if ($titulo && $fechaInicio && $fechaFin) {
            ...
            header('Location: ' . BASE_URL . 'areas/organo_interno/calendario.php?flash=evento_creado');
            exit;
        } else {
        ...
        if ($id > 0 && $titulo && $fechaInicio && $fechaFin) {
            ...
            header('Location: ' . BASE_URL . 'areas/organo_interno/calendario.php?flash=evento_editado');
            exit;
        } else {
        ...
        if ($id > 0) {
            ...
            $stmt->execute([$id]);
            header('Location: ' . BASE_URL . 'areas/organo_interno/calendario.php?flash=evento_eliminado');
            exit;
        }
        ...
        if ($titulo) {
            ...
            header('Location: ' . BASE_URL . 'areas/organo_interno/calendario.php?flash=tarea_creada#kanban');
            exit;
        }
        ...
        if ($id > 0 && $titulo) {
            ...
            header('Location: ' . BASE_URL . 'areas/organo_interno/calendario.php?flash=tarea_editada#kanban');
            exit;
        }
        ...
        if ($id > 0 && in_array($nuevoEstatus, ['pendiente', 'en_proceso', 'completada'])) {
            ...
            header('Location: ' . BASE_URL . 'areas/organo_interno/calendario.php?flash=tarea_movida#kanban');
            exit;
        }
        ...
        if ($id > 0) {
            ...
            $stmt->execute([$id]);
            header('Location: ' . BASE_URL . 'areas/organo_interno/calendario.php?flash=tarea_eliminada#kanban');
            exit;
        }
    }
}
