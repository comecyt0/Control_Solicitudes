<?php
/**
 * COMECyT — Agenda y Tablero de Tareas (Desarrollo Tecnologico y Vinculacion)
 * Calendario de eventos + Kanban de area, patron identico a Difusion.
 * cve_area = 12 | Color primario: Violet #6d28d9
 */
...
$extraHead = '<style>
:root{--color-primary:#6d28d9;--color-primary-dark:#4c1d95;--color-primary-hover:#7c3aed;--color-accent:#B19A6D;}
...
.modal-header{background:linear-gradient(135deg,var(--color-primary),var(--color-primary-dark,#4c1d95));color:#fff;padding:1.25rem 1.5rem;display:flex;align-items:center;justify-content:space-between;}
...
.btn-primary-dt:hover{background:var(--color-primary-hover,#7c3aed)!important;}
