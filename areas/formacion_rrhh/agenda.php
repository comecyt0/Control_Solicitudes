<?php
/**
 * COMECyT — Agenda y Tablero de Tareas (Formacion y RRHH y Vinculacion)
 * Calendario de eventos + Kanban de area, patron identico a Difusion.
 * cve_area = 12 | Color primario: Violet #0f766e
 */
...
$extraHead = '<style>
:root{--color-primary:#0f766e;--color-primary-dark:#0a4b46;--color-primary-hover:#14b8a6;--color-accent:#B19A6D;}
...
.modal-header{background:linear-gradient(135deg,var(--color-primary),var(--color-primary-dark,#0a4b46));color:#fff;padding:1.25rem 1.5rem;display:flex;align-items:center;justify-content:space-between;}
...
.btn-primary-dt:hover{background:var(--color-primary-hover,#14b8a6)!important;}
