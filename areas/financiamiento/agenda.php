...
$extraHead = '<style>
:root{--color-primary:#064e3b;--color-primary-dark:#022c22;--color-primary-hover:#065f46;}
...
.calendar-header-nav h3{margin:0;font-size:1.4rem;font-weight:700;color:#064e3b;}
...
.btn-nav:hover{background:#f8fafc;color:#064e3b;}
...
.calendar-cell.today .day-number{color:#fff;background:#064e3b;font-weight:700;}
...
.btn-evento-accion:hover{background:#fff;color:#064e3b;}
.nota-fin{background:#ede9fe;border-top:3px solid #064e3b;}
...
.tarea-card{background:#fff;border-radius:10px;box-shadow:0 2px 4px rgba(0,0,0,.04);border:1px solid #e2e8f0;padding:1.25rem;cursor:grab;border-top:5px solid #064e3b;transition:all .2s;}
...
.ag-form-control:focus{border-color:#064e3b;box-shadow:0 0 0 3px rgba(109,40,217,.12);background:#fff;outline:none;}
.mb-16{margin-bottom:16px;}
.btn-ag-primary{background:#064e3b!important;border-color:#064e3b!important;color:#fff!important;}
.btn-ag-primary:hover{background:#065f46!important;}
...
<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:24px;flex-wrap:wrap;gap:12px;">
    ...
    <button class="btn" onclick="agAbrirModal('modalCrearEvento')" style="background:#064e3b;border-color:#064e3b;color:#fff;">
        ...
        <?php for ($dia = 1; $dia <= $diasEnMes; $dia++):
            ...
            <div class="calendar-cell <?= $esHoy ? 'today' : '' ?>" onclick="agAbrirCrearDesdeCelda('<?= $fechaIso ?>')">
                ...
                <?php foreach ($calEvs[$dia] ?? [] as $ev):
                    ...
                    $claseNota = $esCumple ? 'nota-dorado' : ($esInstitucional ? 'nota-institucional' : 'nota-fin');
...
<div class="agenda-modal-backdrop" id="modalCrearEvento" style="display:none;" onclick="if(event.target===this)agCerrarModal('modalCrearEvento')">
    <div class="agenda-modal" style="animation:agFadeIn .25s;">
        <div class="agenda-modal-header" style="background:linear-gradient(135deg,#064e3b,#022c22);">
