<?php
/**
 * COMECyT — Agenda y Tablero de Tareas (Apoyo a Investigacion Cientifica y Vinculacion)
 * Calendario de eventos + Kanban de area, patron identico a Difusion.
 * cve_area = 12 | Color primario: Violet #3730a3
 */
...
$extraHead = '<style>
:root{--color-primary:#3730a3;--color-primary-dark:#1e1b6b;--color-primary-hover:#4338ca;--color-accent:#B19A6D;}
...
.modal-header{background:linear-gradient(135deg,var(--color-primary),var(--color-primary-dark,#1e1b6b));color:#fff;padding:1.25rem 1.5rem;display:flex;align-items:center;justify-content:space-between;}
...
.btn-primary-dt:hover{background:var(--color-primary-hover,#4338ca)!important;}
