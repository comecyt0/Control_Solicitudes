<?php
/**
 * COMECyT — Agenda y Tablero de Tareas (Juridico-Administrativo y Vinculacion)
 * Calendario de eventos + Kanban de area, patron identico a Difusion.
 * cve_area = 12 | Color primario: Violet #1e3a5f
 */
...
$extraHead = '<style>
:root{--color-primary:#1e3a5f;--color-primary-dark:#142845;--color-primary-hover:#254a78;--color-accent:#B19A6D;}
...
.modal-header{background:linear-gradient(135deg,var(--color-primary),var(--color-primary-dark,#142845));color:#fff;padding:1.25rem 1.5rem;display:flex;align-items:center;justify-content:space-between;}
...
.btn-primary-dt:hover{background:var(--color-primary-hover,#254a78)!important;}
